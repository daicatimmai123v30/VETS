...
import { CLOSE_CHAT, TOKEN, UNIQUE_CHAT, UNIQUE_ROOM_CHAT, USER_LOGOUT } from '../../actions/types'
        ...
        <div className="container-left">
                        ...
                        (
                            <div className="user-information">
                                ...
                                <button className="btn-process" onClick={()=>history.push('/list-pet')}>
                                    <label className="btn-label">
                                        Hồ sơ thú cưng
                                    </label>
                                    <ion-icon name="paw-outline" style={{fontSize:'40px',color:'#1E3A28'}}></ion-icon>
                                </button>
                                <button className="btn-process"  onClick={()=>history.push('/Appointment')}>
                                    <label className="btn-label">
                                        Lịch hẹn
                                    </label>
                                ...
                                {user.user.role==="ADMIN"||user.user.role==="DOCTOR"?(
                                    <button className="btn-process" onClick={()=>history.push('/Schedule')}>
                                        <label className="btn-label">
                                            Lịch làm việc
                                        </label>
                                        <ion-icon name="calendar-outline" style={{fontSize:'40px',color:'#1E3A28'}}></ion-icon>
                                ...
                                {user.user.role==="DOCTOR"||user.user.role==="ADMIN"?(
                                    <button className="btn-process" onClick={()=>history.push('/list-pet-owner')}>
                                        <label className="btn-label">
                                            Chủ vật nuôi
                                        </label>
                                        <ion-icon name="person-circle" style={{fontSize:'40px',color:'#1E3A28'}}></ion-icon>
                                ...
                                <button className="btn-process" onClick={()=>history.push('/Facility')}>
                                    <label className="btn-label">
                                        Phòng khám
                                    </label>
                                ...
                                <button className="btn-process" onClick={()=>history.push('/Support')}>
                                    <label className="btn-label">
                                        Hỗ trợ
                                    </label>
